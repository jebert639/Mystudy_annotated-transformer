...
# 4. 启动推理界面, 加载模型即可续写
launch_gui.bat   # 或: python model_gui.py
```
...
├── PROJECT_INTRO.md              # ★新增 本文档（开源时可改名 README.md 替换原版）
│
...
├── README.md                     # 原版英文说明
├── LICENSE                       # MIT License（原版，Alexander Rush）
...
python model_gui.py           # 或命令行
python transformer_api.py gui # 或经工具箱
```
